...
public class OpenVATEditor : EditorWindow
{
    ...
    private void SetJSONParameters(Material material, string jsonPath, string vatTexturePath)
    {
        ...
        //HEEEEEREEEE was a bug
        Vector3 minValues = new Vector3(remapData.os_remap.Min[0], remapData.os_remap.Min[1], remapData.os_remap.Min[2]);
        Vector3 maxValues = new Vector3(remapData.os_remap.Max[0], remapData.os_remap.Max[1], remapData.os_remap.Max[2]);
